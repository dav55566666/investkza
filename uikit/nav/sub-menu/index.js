...
const SubNav = () => {
    ...
    useEffect(() => setIsAuth(isAuthorizated()), [isAuth]);
    ...
    const menu2 = (
        <Menu>
            ...
            {isAuth ? (
                <>
                    <Menu.Item onClick={handleToggleLogin}>
                        <Button
                            onClick={() => (window.location.href = `${window.location.origin}/usertokens`)}
                            color={'green'}
                        >
                            {t('cabinet')}
                        </Button>
                    ...
                    <Menu.Item onClick={handleLogout}>
                        <Button color={'submit'}>{t('log_out')}</Button>
                    </Menu.Item>
                </>
            ) : (
                <>
                    <Menu.Item onClick={handleToggleLogin}>
                        <Button onClick={handleToggleLogin} color={'green'}>
                            {t('sign_in')}
                        </Button>
                    </Menu.Item>
            ...
            <div className="container">
                <div className="sub-nav_content">
                    ...
                    <div className="mobilesub-nav">
                        <a className="mobilesub-nav-left" href="/">
